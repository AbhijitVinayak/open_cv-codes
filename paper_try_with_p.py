...
import operator
def main():
    src=cv2.imread('./imagesRGB/RGB85.png')
    ...
    '''
    lines=cv2.HoughLinesP(horizontal,1,math.pi/180,threshold=40,minLineLength=100,maxLineGap=20)
    #print(len(lines))
    ...
    spare_list.reverse()
    print(spare_list)
    r=spare_list.index(max(spare_list))
    # print(l)
    # print(r)
